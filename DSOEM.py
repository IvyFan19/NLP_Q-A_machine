...
class DSOEM(object):
    ...
    # Mar 22, 2021, modified the google - knowledge graph search API by Xinwei
    ...
    def get_kg_data_objects(self):
        # print("@@@@@@self._kg_data", self._kg_data)
        return self._kg_data

    def original_question(self):
        # print("@@@@@@self._original_q", self._original_q)
        return self._original_q

    def labeled_answer(self):
        # print("@@@@@self._labeled_answer", self._labeled_answer)
