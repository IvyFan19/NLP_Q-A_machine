...
parser.add_argument('--ds', dest='ds', required=False,
                    help="Specify data source, choices are 'gkg' for Google KG or 'dkg' for Diffbot KG")
parser.add_argument('--ds-api-key', dest='ds_api_key', required=False,
                    help="Specify API key/token for the given data source")
