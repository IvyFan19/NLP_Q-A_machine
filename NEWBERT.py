...
def newBert(question, answer_text):
    """
    question: string. The question you wanna ask
    answer_text: the string of text that contains info for your question.
...
# newBert(question, answer_text)

# question2 = "What are some example applications for BERT?"
# newBert(question2, answer_text)